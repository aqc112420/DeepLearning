...
file1 = "D:\python_machine-learning\DataSets\MNIST_data"
mnist = input_data.read_data_sets(file1,one_hot=False)
...
input_fn = tf.estimator.inputs.numpy_input_fn(
    x={"images":mnist.test.images},y=mnist.test.labels,batch_size=\
